...
- Script::Compile => ScriptCompiler::Compile =>
 ...
      
[interpreter]
bytecode instruction genetation
isolate init => interpreter initialize =>
  - BYTECODE_LIST(GEMERATE_CODE) => install bytecode 
    - GenerateBytecodeHandler =>
      - interpreter assembler
      - interpreter generater
      - interpreter generater do<bytecode name> (e.g. doLdaZero)
      - code assembler generatecode
  
compilationjob
execute =>
  - BytrcodeGenerater::generateBytecode
finalize =>
  - BytecodeGemerater::finalizeBytecode (emit bytecode array)
  - set bytecode array
  - setcode interpreter enry ttranpoline
