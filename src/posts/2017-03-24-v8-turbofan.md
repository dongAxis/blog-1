...
Frame size 32
  ...
  102 S> 0x74567b2c598 @   10 : 8c                Return
   64 S> 0x74567b2c599 @   11 : 04                LdaUndefined
         ...
         0x74567b2c59c @   14 : 0a 00 05          LdaGlobal [0], [5] // last argument is feedback slot ?
         0x74567b2c59f @   17 : 1f fa             Star r0
   78 E> 0x74567b2c5a1 @   19 : 38 01 02 07       SubSmi [1], a0, [7]
         0x74567b2c5a5 @   23 : 1f f8             Star r2
   71 E> 0x74567b2c5a7 @   25 : 47 fa f9 f8 03    Call1 r0, r1, r2, [3] // last argument is feedback slot ?
...
- BytecodeGenerator::VisitCall =>
  - (if Call::GetCallType == GLOBAL_CALL (e.g. outer scope's variable reference ?))
    - BuildVariableLoadForAccumulatorValue (emit global variable load for "fib0") =>
      - ?
  - VisitArguments
  - BytecodeArrayBuilder::Call (with Call::CallFeedbackICSlot (how do you get this?)) =>
    - ?
...
- CodeAssembler::GenerateCode =>
  ...
  - (CallICDescriptor => Immediate, where ?!)
  - ... => AssembleArchInstruction =>
    - (case kArchCallCodeObject) MacroAssembler::Call(code, RelocInfo::CODE_TARGET)


[ CallICStub code generation (CallICStub::GetCode) ]

CodeStub::GetCode => TurboFanCodeStub::GenerateCode => CallICStub::GenerateAssembly
? => TF_STUB
...
```
Handle, Zone
Map (extends HeapObject) looks important ?
```
