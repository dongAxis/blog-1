...
- Heap::CollectGarbage =>
 ...
        - IterateAndScavengePromotedObject => ?
        - Q. what is PromotionQueue for ? (object age is tracked by age_mark in new space, right ?)
          - is this "promoted heap object queue" ?
...
- ScavenginVisitor::EvacuateObject =>
  ...
  - otherwise PromoteObject =>
    ...
    - if migratedObject is POINTER_OBJECT then PromotionQueue::insert
