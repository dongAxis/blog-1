...
- unreal engine
  - play with post process shader (custom depth, stencil)
  - play with volumentric, translucency stuff  
  - import asset from blender
    ...
    - FBasePassOpaqueDrawingPolicyFactory::AddStaticMesh =>
      ...
      - ProcessBasePassMesh =>
        ...
        - FDrawBasePassStaticMeshAction::Process =>
          - construct TBasePassDrawingPolicy<LightMapPolicyType> =>
...
- unreal engine rendering (basic shader programs in detail)
  - base pass shader (how precomputed light contribute to scene color calculation)
  - direct light pass shader
  - dynamic shadow
...
- unreal engine architecture
  ...
  - [ ] light precomputing
  - [ ] editor architecture `UUnrealEdEngine`, PIE (separate Viewport, separate world)
  - [ ] particle system
